...
В [одной из предыдущих публикаций нашего блога](https://habr.com/company/hh/blog/415437/), а именно пункте "Грабли №6" рассказывалось о технологии DSSM, которая позволяет превратить текст в векторы. 
